            ...
            <section className=" text-gray-600">
                <div className="container mx-auto px-5 py-24">
                    <div className="mb-20 flex w-full flex-wrap">
                        ...
                        <p className="w-full leading-relaxed text-gray-500 lg:w-1/2">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac humblebrag.</p>
                    </div>
                    <div className="-m-4 flex flex-wrap">
                        <div className="p-4 md:w-1/2 xl:w-1/4">
                            <div className="rounded-lg bg-gray-100 p-6">
                                <img className="mb-6 h-40 w-full rounded object-cover object-center" src="https://dummyimage.com/720x400" alt="content" />
                        ...
                        <div className="p-4 md:w-1/2 xl:w-1/4">
                            <div className="rounded-lg bg-gray-100 p-6">
                                <img className="mb-6 h-40 w-full rounded object-cover object-center" src="https://dummyimage.com/721x401" alt="content" />
                                <h3 className=" text-xs font-medium tracking-widest text-indigo-500">SUBTITLE</h3>
                        ...
                        <div className="p-4 md:w-1/2 xl:w-1/4">
                            <div className="rounded-lg bg-gray-100 p-6">
                                <img className="mb-6 h-40 w-full rounded object-cover object-center" src="https://dummyimage.com/722x402" alt="content" />
                                <h3 className=" text-xs font-medium tracking-widest text-indigo-500">SUBTITLE</h3>
                        ...
                        <div className="p-4 md:w-1/2 xl:w-1/4">
                            <div className="rounded-lg bg-gray-100 p-6">
                                <img className="mb-6 h-40 w-full rounded object-cover object-center" src="https://dummyimage.com/723x403" alt="content" />
                                <h3 className=" text-xs font-medium tracking-widest text-indigo-500">SUBTITLE</h3>
