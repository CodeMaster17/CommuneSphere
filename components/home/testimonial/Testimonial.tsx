        ...
        <>
            <section className=" text-gray-600">
                <div className="container mx-auto px-5 pt-20">
                    <h1 className=" mb-12 text-center text-3xl font-medium text-gray-900">Testimonials</h1>
                    <div className="-m-4 flex flex-wrap">
                        <div className="w-full p-4 md:w-1/2">
                            <div className="h-full rounded border bg-card p-8 text-card-foreground shadow-md">
                                ...
                                <a className="inline-flex items-center">
                                    <Image alt="testimonial" src="/person1.avif" className="size-12 shrink-0 rounded-full object-cover object-center" width="100" height="100" />
                                    <span className="flex grow flex-col pl-4">
                                        <span className=" font-medium text-gray-900">Holden Caulfield</span>
                        ...
                        <div className="w-full p-4 md:w-1/2">
                            <div className="h-full rounded border bg-card p-8 text-card-foreground shadow-md">
                                ...
                                <p className="mb-6 leading-relaxed">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90s microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
                                <a className="inline-flex items-center">
                                    <Image alt="testimonial" src="/person2.avif" className="size-12 shrink-0 rounded-full object-cover object-center" width="100" height="100" />
                                    <span className="flex grow flex-col pl-4">
                                        <span className=" font-medium text-gray-900">Alper Kamu</span>
